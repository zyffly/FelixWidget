 ...
 * 单位转换 dp ->px
 */
fun Float.dipToPx() = (this * DENSITY + 0.5f).toInt()

/**
 * 单位转换 px ->dp
 */
fun Float.pxToDip() = (this / DENSITY + 0.5f).toInt()

/**
 * 单位转换: sp -> px
 */
fun Int.spToPx() = (FONT_DENSITY * this + 0.5).toInt()

/**
 * 单位转换: px -> sp
 */
fun Float.pcToSp() = (this / FONT_DENSITY + 0.5).toInt()
